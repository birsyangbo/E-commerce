...
|---|---|---|
| ![Admin](ss/admin.png) | ![Profile](ss/profile.png) | ![Orders](ss/orders.png) |

### Shopping Experience
| Home / Offers | Product Listing | Product Details |
|---|---|---|
| ![Offer](ss/offer.png) | ![Main](ss/main.png) | ![Detail](ss/detail.png) |

### Checkout & eSewa Payment Flow
| Shopping Cart | eSewa Login | Payment Confirmation | Success Page |
|---|---|---|---|
| ![Cart](ss/cart.png) | ![Payment1](ss/payment1.png) | ![Payment2](ss/payment2.png) | ![Success](ss/success.png) |
